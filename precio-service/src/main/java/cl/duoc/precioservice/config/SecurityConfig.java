    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/precios/**").hasAnyRole("DUENIO", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/precios/**").hasAnyRole("DUENIO", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/precios/**").hasAnyRole("DUENIO", "ADMIN")
