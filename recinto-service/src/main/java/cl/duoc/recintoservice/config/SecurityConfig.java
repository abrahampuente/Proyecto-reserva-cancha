    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Público solo para consultar recintos
                        .requestMatchers(HttpMethod.GET, "/api/recintos/**").permitAll()

                        // Crear, editar y eliminar solo DUENIO o ADMIN
                        .requestMatchers(HttpMethod.POST, "/api/recintos/**").hasAnyRole("DUENIO", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/recintos/**").hasAnyRole("DUENIO", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/recintos/**").hasAnyRole("DUENIO", "ADMIN")
