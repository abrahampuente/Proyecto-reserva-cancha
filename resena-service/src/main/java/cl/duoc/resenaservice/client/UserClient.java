package cl.duoc.resenaservice.client;
...
public class UserClient {
    ...
    public void validateClienteOrAdminExists(Long usuarioId) {
        if (usuarioId == null) {
            throw new BusinessRuleException("El usuario es obligatorio");
        }
        ...
        if (!"CLIENTE".equals(role) && !"ADMIN".equals(role)) {
            throw new BusinessRuleException("Solo un usuario CLIENTE o ADMIN puede registrar reseñas");
        }
    }
}