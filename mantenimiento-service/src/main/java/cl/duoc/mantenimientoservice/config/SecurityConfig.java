package cl.duoc.mantenimientoservice.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/mantenimientos/**")
                        .hasAnyRole("CLIENTE", "DUENIO", "ADMIN")

                        // Crear mantenimiento
                        .requestMatchers(HttpMethod.POST, "/api/mantenimientos/**")
                        .hasAnyRole("DUENIO", "ADMIN")

                        // Actualizar mantenimiento
                        .requestMatchers(HttpMethod.PUT, "/api/mantenimientos/**")
                        .hasAnyRole("DUENIO", "ADMIN")

                        // Eliminar mantenimiento
                        .requestMatchers(HttpMethod.DELETE, "/api/mantenimientos/**")
                        .hasAnyRole("DUENIO", "ADMIN")
